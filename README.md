...
A bash script that automates the full deployment of a **3-tier network architecture** on Microsoft Azure, including virtual network setup, virtual machines, and Network Security Group (NSG) configurations with traffic flow verification.
...
- Azure Network Watcher enabled in the `southafricanorth` region (for traffic flow tests)
...
|---|---|---|
| Resource Group | `multitierRG` | Region: South Africa North |
| Virtual Network | `multitier-vnet` | Address space: `10.0.0.0/16` |
